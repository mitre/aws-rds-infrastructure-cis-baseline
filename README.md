...
```
# How to run
inspec exec https://github.com/mitre/aws-rds-infrastructure-cis-baseline/archive/master.tar.gz -t aws:// --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
inspec archive aws-rds-infrastructure-cis-baseline
...
```
cd aws-rds-infrastructure-cis-baseline
git pull
cd ..
inspec archive aws-rds-infrastructure-cis-baseline --overwrite
inspec exec <name of generated archive> -t aws:// --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
To report a bug or feature request, please open an [issue](https://github.com/mitre/aws-rds-infrastructure-cis-baseline/issues/new).
